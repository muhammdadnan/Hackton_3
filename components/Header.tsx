      ...
      <div className="flex w-full flex-wrap items-center justify-between">
        ...
        >
          <input
            ...
            className="bg-gray-100 text-gray-800 px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 border max-w-4xl w-full"
          />
        </Form>
        <div className="flex items-center space-x-4 mt-4 sm:'mt-0 flex-none' flex-1">
          <Link
            href="/basket"
            className='flex-1 relative flex justify-center items-center space-x-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded
          sm:"flex-none justify-start"'
          >
          ...
          <ClerkLoaded>
            <SignedIn>
              <Link
                href="/orders"
                className='flex-1 relative flex justify-center sm:"justify-start flex-none" items-center space-x-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'
              >
